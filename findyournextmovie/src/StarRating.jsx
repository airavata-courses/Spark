...
class StarRating extends React.Component {
  ...
  componentWillMount() {
    ...
    if(localStorage.getItem("isAuthenticated") == "true"){
        axios.get('149.165.170.39:30004/usermovierating/getbyuseridmovieid?user_id=' + localStorage.getItem("ACCESS_TOKEN") + '&movie_id=' + this.props.movie_id)
        .then(res => {
          this.setState({
  ...
  onStarClick(nextValue, prevValue, name) {
    if (localStorage.getItem("isAuthenticated") === null) {
      history.push("/login");
        ...
        axios.post('149.165.170.39:30004/usermovierating/save',  movieData )
            .then(res => {
